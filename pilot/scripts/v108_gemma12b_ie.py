...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument("--src_dir",default="pilot/data/cache/v105_sources"); ap.add_argument("--out_dir",default="pilot/data/cache/v108_gemma12b_ie")
    ...
    llm=LLM(model="google/gemma-4-12b-it",dtype="bfloat16",max_model_len=8192,gpu_memory_utilization=0.90,enforce_eager=True,tensor_parallel_size=2,limit_mm_per_prompt={"image":0,"audio":0})
