...
def main():
    ...
    medkg_cui_path = Path("/mnt/medkg/kg/disease_features_dual_v2_by_cui.json")
    medkg_path = Path("/mnt/medkg/kg/disease_features_dual_v2.json")
    TOP_K_FEATURES = 8
    ...
    print(f"[v308-distinguish-ddxplus] Union: {n_medkg}/{len(disease_features)} have medkg, all have v87. Combined top-{TOP_K_FEATURES*2} per disease.")
