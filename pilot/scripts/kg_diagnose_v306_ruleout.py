...
For each candidate, identify SUPPORTING evidence the patient has and CONTRADICTING evidence the patient has (e.g., features absent that should be present, or features present that should not). The candidate with the strongest support and weakest contradiction is the diagnosis. Avoid picking a candidate the patient's evidence rules out.
