#!/usr/bin/env python3
"""진단 v37: differential diagnosis rule-out 프롬프트.
...
CANDIDATES with typical clinical features:
{cands}

Differential diagnosis approach:
- Rule out candidates whose typical features are clearly INCONSISTENT with this patient.
- Among remaining candidates, choose the one whose typical features BEST FIT the patient's age, chief complaint, and symptom pattern.

Final answer (ONLY the number 1-{len(c['topk'])}):"""
