#!/usr/bin/env python3
"""진단 v57: brief reasoning + score (CoT-lite).
...
How likely is this hypothesis given the patient's presentation?

Format your response as:
Match: <one short sentence about how well symptoms fit>
Score: <0-100>"""
