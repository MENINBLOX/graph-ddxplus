...
def main():
    ...
    # === v200 TEXTBOOK-only KG (StatPearls/GeneReviews/MedlinePlus/Wikipedia, no Orphanet) ===
    ...
    for dc in dcs_list:
        ...
        if feats:
            ...
            if names:
                disease_features[dc] = ", ".join(names)
                n_medkg += 1
    print(f"[v200-textbook-rarebench] Hybrid: {n_medkg}/{len(disease_features)} diseases use textbook IE, rest use v87 PubMed-only", flush=True)
