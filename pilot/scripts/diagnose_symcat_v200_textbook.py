...
def main():
    ...
    # Per-disease hybrid: use textbook IE if available, else fallback to v87 PubMed-only
    ...
    for dn in diseases:
        ...
        if feats:
            ...
            if names:
                ...
                n_medkg += 1
    print(f"[v200-textbook-symcat] Hybrid: {n_medkg}/{len(disease_features)} diseases use textbook IE, rest use v87 PubMed-only", flush=True)
