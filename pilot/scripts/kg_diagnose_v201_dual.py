...
def main():
    ...
    # === v112 TEXTBOOK-only hybrid: textbook+PubMed dual IE where available, v87 PubMed-only elsewhere ===
    ...
    for dn in diseases:
        ...
        if feats:
            ...
            if names:
                ...
                n_medkg += 1
    print(f"[v201-dual-ddxplus] Hybrid: {n_medkg}/{len(disease_features)} diseases use textbook+PubMed dual IE, rest use v87 PubMed-only")
