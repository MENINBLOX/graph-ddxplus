...
def main():
    ...
    # === v110 MEDKG hybrid: medkg where available, v87 PubMed-only elsewhere ===
    ...
    for dn in diseases:
        ...
        if feats:
            ...
            if names:
                ...
                n_medkg += 1
    print(f"[v110-medkg-ddxplus] Hybrid: {n_medkg}/{len(disease_features)} diseases use medkg, rest use v87 PubMed-only")
