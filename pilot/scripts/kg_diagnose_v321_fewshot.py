...
PRESENT: nasal congestion; runny nose; mild fever; sore throat
HISTORY: contact with sick coworker
Candidates:
(1) URTI — typical features: cough, nasal congestion, sore throat, low-grade fever
(2) Influenza — typical features: fever, chills, myalgia, fatigue, headache
(3) Bronchitis — typical features: cough, sputum production, wheezing
EVAL:
(1) URTI: matches mild fever, nasal congestion, sore throat, recent contact — strong support
(2) Influenza: matches fever but no body aches/chills — moderate
(3) Bronchitis: no productive cough or wheezing — weak
PICK: 1
