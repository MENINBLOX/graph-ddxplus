...
GRAPH = "pilot/data/onlykg_graph_v84_s3.pkl"
...
OUT = "docs/forensic_v84_random10x10.md"
...
def main():
    ...
    with open(OUT, "w") as f:
        f.write(f"# v84 (multi-prompt merge s=3) Forensic — Random 10/10\n\n")
        f.write(f"- Config: v71 algorithm + v84 KG (generic+discriminative merge scale=3)\n")
        f.write(f"- DDXPlus 134K @1=62.53%, MRR=0.7426\n\n")
