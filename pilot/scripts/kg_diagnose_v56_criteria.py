#!/usr/bin/env python3
"""진단 v56: 구조화된 평가 기준 (symptom match + demographics + pattern).
...
As an expert clinician, score this diagnostic hypothesis on a 0-100 scale considering:
- Symptom match: do the patient's specific symptoms match the typical presentation?
- Demographic fit: is the age and sex consistent with the disease?
- Symptom pattern: do severity, timing, and characteristics fit the disease?

Reply with ONLY a single integer 0-100 (0=impossible, 100=highly likely)."""
