...
def main():
    ...
    print(f"[v303-hybrid-ddxplus] Union: {n_medkg}/{len(disease_features)} have medkg, all have v87. Combined top-{TOP_K_FEATURES*2} per disease.")
...
PICK: <number>"""
    ...
    print(f"\n  v303 (hybrid+CoT tie-break) @1={100*t1c/n:.2f}% @3={100*t3c/n:.1f}% @5={100*t5c/n:.1f}% @10={100*t10c/n:.1f}%", flush=True)
    print(f"\n{'='*80}", flush=True)
    print(f"v303 GTPA@1 = {100*t1c/n:.2f}% (SUBSET={n})", flush=True)
