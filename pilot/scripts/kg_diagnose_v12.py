...
Which of these diseases is MOST LIKELY for this patient?
{candidates}
...
def structured_patient_profile(evidences, ev_info, age, sex):
    ...
    if history:
        sections.append("HISTORY: " + "; ".join(history[:5]))
...
def main():
    print("=" * 80, flush=True)
    print("진단 v12: 구조화된 환자 프로필 re-ranking", flush=True)
    print("=" * 80, flush=True)
