...
def main():
    ...
    # Per-disease hybrid: use textbook+PubMed dual IE if available, else fallback to v87 PubMed-only
    ...
    for dn in diseases:
        ...
        if feats:
            ...
            if names:
                ...
                n_medkg += 1
    print(f"[v201-dual-symcat] Hybrid: {n_medkg}/{len(disease_features)} diseases use textbook+PubMed dual IE, rest use v87 PubMed-only", flush=True)
