"""Cypher 쿼리 + Stopping 조건 종합 최적화 v4.

목표: IL ~15, Accuracy 최대화
더 공격적인 stopping 조건 테스트
"""
...
def main():
    print("=" * 70)
    print("Cypher + Stopping 종합 최적화 v4")
    print("목표: IL ~15, Accuracy 최대화 (더 공격적인 stopping)")
    print("=" * 70)
    print()
    ...
    # Grid search - 더 낮은 confidence threshold로 IL 줄이기
    denied_thresholds = [5, 6]
    confidence_thresholds = [0.20, 0.22, 0.25, 0.28, 0.30]
    ...
    try:
        ...
        # Save all results
        output_file = Path("/home/max/Graph-DDXPlus/results/cypher_optimization_v4.json")
